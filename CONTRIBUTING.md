...
Discussion of this work occurs on the [Computing-Aware Traffic Steering
Working Group mailing list](mailto:cats@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/cats/),
[subscribe](https://www.ietf.org/mailman/listinfo/cats/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/cats/documents/).
